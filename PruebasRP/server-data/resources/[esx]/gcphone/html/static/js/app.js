    ...
    [
                                ...
                                value: function (t) {
                                    ...
                                    e &&
                                        (void 0 !== this.soundList[e]
                                            ...
                                            : ((this.soundList[e] = new Audio("/html/static/sound/" + e)), (this.soundList[e].loop = !0), (this.soundList[e].volume = s), this.soundList[e].play()));
                                },
                            },
                            {
        ...
        function (t, e, n) {
            ...
            var s = n(12),
                ...
                h = n(82),
                p = n(83);
            s.a.use(o.c), (e.a = new o.c.Store({ modules: { phone: i.a, contacts: a.a, messages: r.a, appels: c.a, bank: u.a, bourse: l.a, tchat: h.a, twitter: p.a }, strict: !0 }));
        },
        ,
        function (t, e, n) {
            "use strict";
        ...
        function (t, e, n) {
            ...
            var s = n(28),
                ...
                m = {
                    ...
                    config: { reseau: "Gannon", useFormatNumberFrance: !1, apps: [], themeColor: "#2A56C6", colors: ["#2A56C6"], language: {} },
                };
                                            ...
                                            switch ((t.prev = t.next)) {
                                                ...
                                                case 2:
                                                    for (o = t.sent, i = p()(o.language), r = !0, c = !1, u = void 0, t.prev = 7, h = l()(i); !(r = (m = h.next()).done); r = !0)
                                                        (v = m.value), void 0 !== (g = o.language[v].TIMEAGO) && f.a.prototype.$timeago.addLocale(v, g);
                                                    t.next = 15;
                                                    break;
                                                case 11:
                        ...
                        if (
                            (null !== this.appelsInfo && !0 !== this.appelsInfo.is_accepts
                                ? (null !== this.soundCall && this.soundCall.pause(),
                                  !0 === this.appelsInfo.initiator ? (this.soundCall = new Audio("/html/static/sound/Phone_Call_Sound_Effect.ogg")) : (this.soundCall = new Audio("/html/static/sound/ring.ogg")),
                                  (this.soundCall.loop = !0),
                                  (this.soundCall.volume = this.volume),
                                  this.soundCall.play())
                                : null !== this.soundCall && (this.soundCall.pause(), (this.soundCall = null)),
                            null === t && null !== e)
                        )
                ...
                methods: {
                    onSelect: function (t) {
                        ...
                        !0 !== this.ignoreControls &&
                            ...
                            l.a.CreateModal({ choix: [].concat(o()(t.subMenu), [{ title: "Retour" }]) }).then(function (t) {
                                                ...
                                                case 0:
                                                    return (
                                                        ...
                                                        (r = [
                                                            ...
                                                            { id: 3, title: e.IntlString("CANCEL"), icons: "fa-undo" },
                                                        ]),
                                                ...
                                                case 2:
                                                    return (
                                                        ...
                                                        (n = [
                                                            ...
                                                            { id: 2, title: t.IntlString("APP_DARKTCHAT_DELETE_CHANNEL"), icons: "fa-minus", color: "orange" },
        ...
        function (t, e, n) {
            ...
            e.default = {
                ...
                methods: o()({}, n.i(i.a)(["updateContact", "addContact"]), {
                    ...
                    save: function () {
                        -1 !== this.id ? this.updateContact({ id: this.id, display: this.contact.display, number: this.contact.number }) : this.addContact({ display: this.contact.display, number: this.contact.number }), history.back();
                    },
                    cancel: function () {
                            ...
                            u.a
                                ...
                                .then(function (n) {
                                    1 === n.id
                                        ...
                                        : 5 === n.id
                                        ? e.startCall({ numero: "#" + t.number })
                                        : 6 === n.id && e.$router.push({ name: "messages.view", params: t }),
                                        (e.disableList = !1);
                                }));
                    },
                    back: function () {
                    ...
                    messagesData: function () {
                        ...
                        return (
                            o()(s).forEach(function (t) {
                                i.push({ display: s[t].display, puce: s[t].noRead, number: t, lastMessage: s[t].lastMessage, keyDesc: s[t].keyDesc, backgroundColor: s[t].backgroundColor, icon: s[t].icon, letter: s[t].letter });
                            }),
                            i.sort(function (t, e) {
                    ...
                    paramList: function () {
                        ...
                        return (
                            ...
                            [
                                ...
                                { icons: "fa-mouse-pointer", title: this.IntlString("APP_CONFIG_MOUSE_SUPPORT"), onValid: "onChangeMouseSupport", values: l()({ Yes: !0, No: !1 }, n) },
                                { icons: "fa-exclamation-triangle", color: "#c0392b", title: this.IntlString("APP_CONFIG_RESET"), onValid: "resetPhone", values: l()({}, s, n) },
                            ]
                        );
                    },
        ...
        function (t, e, n) {
            ...
            e.default = {
                components: {},
                data: function () {
                    return { STATES: f, state: f.MENU, localAccount: { username: "", password: "", passwordConfirm: "", avatarUrl: null }, notification: 0, notificationSound: !1 };
                },
                ...
                computed: o()({}, n.i(m.b)(["IntlString", "useMouse"]), {
                    screen: function () {
                        return [
                            ...
                            { title: this.IntlString("APP_TWITTER_VIEW_TWEETER"), component: l.a, icon: "fa-comment" },
                                            ...
                                            [
                                                ...
                                                n(
                                                    ...
                                                    [
                                                                ...
                                                                [
                                                                    1 === s.accepts && 1 === s.incoming
                                                                        ...
                                                                        ? n(
                                                                              "svg",
                                                                              {
                                                                                  attrs: { viewBox: "0 0 24 24", fill: "#D32F2F" },
                                                                                  on: {
                                                                                      click: function (n) {
                                                                                          return n.stopPropagation(), t.selectItem(e);
                                                                                      },
                                                        ...
                                                        t._v(" "),
                                                        0 !== e.lastCall.length ? n("div", { staticClass: "lastCall" }, [n("timeago", { attrs: { since: e.lastCall[0].date, "auto-update": 20 } })], 1) : t._e(),
                                                    ],
                                                    2
                                                ),
                                            ]
            ...
            t.exports = {
                render: function () {
                    ...
                    return n(
                        ...
                        { staticClass: "phone_app" },
                        [
                            n("PhoneTitle", { attrs: { title: t.channelName, backgroundColor: "#090f20" }, on: { back: t.onQuit } }),
                            t._v(" "),
        ...
        function (t, e) {
            t.exports = {
                render: function () {
                    ...
                    return n(
                        "div",
                        { staticClass: "home", style: { background: "url(" + t.backgroundURL + ")" } },
                        [
                            n("InfoBare"),
                            t._v(" "),
            ...
            t.exports = {
                render: function () {
                    ...
                    return n(
                        ...
                        { staticClass: "phone_app" },
                        [
                            n("PhoneTitle", { attrs: { title: t.IntlString("APP_DARKTCHAT_TITLE"), backgroundColor: "#090f20" }, on: { back: t.onBack } }),
                            t._v(" "),
                            n(
                                "div",
                                {
            ...
            t.exports = {
                render: function () {
                    ...
                    return n(
                        "div",
                        { staticClass: "screen" },
                        [n("list", { attrs: { list: t.messagesData, disable: t.disableList, title: t.IntlString("APP_MESSAGE_TITLE") }, on: { back: t.back, select: t.onSelect, option: t.onOption } })],
                        1
                    );
                },
                staticRenderFns: [],
                                ...
                                ? n(
                                      ...
                                      [
                                          n("div", { staticClass: "phone_wrapper" }, [
                                              n("div", { staticClass: "phone_coque", style: { backgroundImage: "url(/html/static/img/coque/" + t.coque.value + ")" } }),
                                              t._v(" "),
            ...
            t.exports = {
                render: function () {
                    var t = this,
                        e = t.$createElement,
                        n = t._self._c || e;
                    return n("div", { staticClass: "screen", on: { click: t.onBackspace } }, [
                        n("div", { staticClass: "elements" }, [
                            n("img", { staticClass: "logo_maze", attrs: { src: "/html/static/img/app_bank/logo_mazebank.jpg" } }),
                            t._v(" "),
                            n("div", { staticClass: "hr" }),
                            t._v(" "),
                            n("div", { staticClass: "element" }, [n("div", { staticClass: "element-content" }, [n("span", [t._v("$ " + t._s(t.bankAmontFormat))])])]),
                        ]),
                    ]);
                },
                staticRenderFns: [],
            ...
            t.exports = {
                render: function () {
                    ...
                    return n(
                        ...
                        { staticClass: "phone_app" },
                        [
                            n("PhoneTitle", { attrs: { title: t.currentScreen.title, backgroundColor: "#1da1f2" }, on: { back: t.quit } }),
                            t._v(" "),
            ...
            t.exports = {
                render: function () {
                    ...
                    return n(
                        ...
                        [
                            n("PhoneTitle", { attrs: { title: t.displayContact, backgroundColor: t.color }, on: { back: t.quit } }),
                            t._v(" "),
                            void 0 !== t.imgZoom
                                ? n(
                                      "div",
                                            ...
                                            n(
                                                ...
                                                [
                                                    ...
                                                    n(
                                                        ...
                                                        [n("timeago", { staticClass: "sms_time", style: t.colorSmsOwner[e.owner], attrs: { since: e.time, "auto-update": 20 } })],
                                                        1
                                                    ),
                                                ]
                                            ),
