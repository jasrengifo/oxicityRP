...
ESX.RegisterServerCallback('esx_O_Blackmarket:requestDBItems', function(source, cb)
	if not hasSqlRun then
...
RegisterServerEvent('esx_O_Blackmarket:buyItem')
AddEventHandler('esx_O_Blackmarket:buyItem', function(itemName, amount, zone)
	...
	if amount < 0 then
		print('esx_O_Blackmarket: ' .. xPlayer.identifier .. ' attempted to exploit the shop!')
		return
	end
